...
const Result = () => {
   ...
   const onSubmitHandler=async (e)=>{
    e.preventDefault()//this will disable the loading when we submit the form
    setLoading(true)
    if(input){
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col min-h-[90vh] justify-center items-center'>
      ...
      {!isImageLoaded
      ?
      <div className='flex w-full max-w-xl plcaeholder-color bg-neutral-500 text-white text-sm p-0.5 mt-10 rounded-full'>
